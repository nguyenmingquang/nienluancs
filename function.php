...
function taodonhang($name,$address,$phone,$email,$total,$pttt){
    $conn=ketnoidb();
    $sql = "INSERT INTO bill(name,address,phone,email,total,pttt) VALUES ('$name','$address','$phone','$email','$total','$pttt')";
    // use exec() because no results are returned
    $conn->exec($sql);
