    ...
    <div class="row mb header">  
        ...
        <div class="row mb ">
            <div class="boxtrai mr">
                ...
                <div class="row mb">
                    <h1>Chi tiết sản phẩm của các đơn hàng</h1>
                    <?php
                echo "<table style='border:solid 4px black;'>";
                echo "<tr><th>STT</th><th>Tên sản phẩm</th><th>Đơn giá</th><th>Số lượng</th><th>Thành tiền</th><th>ID Đơn hàng</th><th>Thời gian</th></tr>";
                class TableRows extends RecursiveIteratorIterator {
                    ...
                    try {
                         ...
                         $stmt = $conn->prepare("SELECT  id,tensp,dongia ,soluong,thanhtien,idbill ,created_at FROM cart"); 
                         $stmt->execute();
