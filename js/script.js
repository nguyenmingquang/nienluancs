(function() {
  ...
  function displayCartTotal() {
    ...
    if (prices) {
      ...
      totalPriceContainer.innerHTML = `<span class="total">Tổng: ${total.toFixed()} VNĐ</span>`;
    } else {
      totalPriceContainer.innerHTML = '<span class="total">Tổng: 0 VNĐ</span>';
    }
  }
  ...
  function saveProduct(clickedBtn) {
    ...
    const prodPrice = cardInfo.querySelector(".card_price").textContent;
  ...
  function checkout() {
    ...
    if (cartProducts !== "" && confirm("Bạn có muốn thanh toán?")) {
      clearCart();
    } else {
      return;
    }
