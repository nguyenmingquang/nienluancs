        ...
        <div class="row mb ">
            <div class="boxtrai mr">
                ...
                <div class="row mb">
                    ...
                    <p><a href="chitiet.php">Xem chi tiết sản phẩm của đơn hàng</a></p>
                    <?php
                echo "<table style='border:solid 4px black;'>";
                echo "<tr><th>STT</th><th>Họ tên</th><th>Địa chỉ</th><th>SĐT</th><th>Email</th><th>Tổng</th><th>Phương thức thanh toán</th><th>Thời gian</th></tr>";
                class TableRows extends RecursiveIteratorIterator {
                    ...
                    try {
                         ...
                         $stmt = $conn->prepare("SELECT  id, name, address, phone, email,total,pttt, created_at FROM bill"); 
                         $stmt->execute();
